    ...
    <>
      <div className="flex justify-between p-4">
        <h1 className="text-lg capitalize flex items-center gap-2">
          <Check className="ring-1 rounded-full p-2 text-green-500" /> Voting
          Panel
        </h1>
          ...
          >
            ...
            <CardContent className="flex justify-center gap-4 items-center text-lg">
              ...
              <div>
                ...
                <p className="text-xs">{candidate.party}</p>
              </div>
            </CardContent>
          </Card>
        ))}
      ...
      {selected && (
        <div className="flex justify-center items-center ">
          <Button
            className="px text-md font-bold "
